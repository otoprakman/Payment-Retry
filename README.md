...
We don’t know if the Predicted-1 is correct, on the other hand if there is already any retry before that time then we can clearly say that number of declined attempt is reduced.
We don’t know if the Predicted-2 is correct. We clearly see that time to approval is increased. However number of declined authorization attempt declined.

![reg2](https://user-images.githubusercontent.com/53580699/134407048-d53bc3b3-fa96-4928-a2f2-bcdbff1791b6.png)

Total Billing Series: 2150 (Response_F (0/1) : 2083/67)
